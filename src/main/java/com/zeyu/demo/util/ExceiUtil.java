...
import com.zeyu.demo.exception.CustomException;
import com.zeyu.demo.pojo.AjaxResult;
import com.zeyu.demo.util.excle.in.ReflectUtils;
...
import com.zeyu.demo.util.Excel.Type;

import java.util.stream.Collectors;

/**
 * @program: SpringBootTest
 * @description: excel导入转成list
 * @author: chenhu
...
public class ExceiUtil<T> {
    ...
    public ExceiUtil(Class<T> clazz) {
        this.clazz = clazz;
    }
     ...
     * @return 转换后集合
     */
    public List<T> importExcel(InputStream is) throws InstantiationException, IllegalAccessException, IOException, InvalidFormatException {
     ...
     * @return 转换后集合
     */
    public List<T> importExcel(String sheetName, InputStream is) throws IOException, InvalidFormatException, IllegalAccessException, InstantiationException, InvalidFormatException {
...
//        String downloadPath = FileUploadUtils.getAccessory() + filename;
        String downloadPath = "home/gateway/upload" + filename;
